...
class RESTClientObject(object):
    ...
    def PUT(self, url, headers=None, post_params=None, body=None, query_params=None):
        return self.request("PUT", url, headers=headers, post_params=post_params, body=body, query_params=query_params)
